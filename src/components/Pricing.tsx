          ...
          <div className="bg-card rounded-3xl border border-border p-8 md:p-12 shadow-xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10">
              <div className="text-center p-6 rounded-2xl bg-secondary/50">
                ...
                <h3 className="text-lg font-semibold text-foreground mb-2">Cakes</h3>
                <p className="text-3xl font-bold text-primary mb-1">From ₦1,200</p>
                <p className="text-sm text-muted-foreground">and above</p>
              </div>
              <div className="text-center p-6 rounded-2xl bg-secondary/50">
                <div className="text-4xl mb-3">🥧</div>
                <h3 className="text-lg font-semibold text-foreground mb-2">Meatpie</h3>
                <p className="text-3xl font-bold text-primary mb-1">₦3,500</p>
                <p className="text-sm text-muted-foreground">Box of 3</p>
              </div>
            </div>

            {/* Notice */}
            <div className="flex items-start gap-4 p-6 rounded-2xl bg-gold/10 border border-gold/30">
              <div className="p-2 rounded-full bg-gold/20">
                <Info className="w-5 h-5 text-gold-dark" />
              </div>
              <div>
                <h4 className="font-semibold text-foreground mb-1">Pricing Notice</h4>
