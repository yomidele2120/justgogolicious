...
const galleryItems: GalleryItem[] = [
  { id: 1, title: "Birthday Cake", category: "Cakes", isBestSeller: true, placeholder: "🎂", bgColor: "bg-purple-light/50" },
  { id: 2, title: "Meatpie Box", category: "Pastries", isBestSeller: true, placeholder: "🥧", bgColor: "bg-secondary" },
  { id: 3, title: "Cake Parfait", category: "Desserts", isBestSeller: true, placeholder: "🍰", bgColor: "bg-gold/20" },
  { id: 4, title: "Cupcake Set", category: "Cupcakes", placeholder: "🧁", bgColor: "bg-purple-light/30" },
  { id: 5, title: "Doughnuts", category: "Pastries", placeholder: "🍩", bgColor: "bg-secondary" },
  { id: 6, title: "Chin Chin", category: "Snacks", placeholder: "🍪", bgColor: "bg-gold/30" },
  { id: 7, title: "Foil Cake", category: "Cakes", placeholder: "🧁", bgColor: "bg-purple-light/40" },
  { id: 8, title: "Custom Cake", category: "Cakes", placeholder: "🎂", bgColor: "bg-secondary" },
];
    ...
    <section id="gallery" className="py-20 md:py-28 bg-muted/50">
      ...
      {selectedImage && (
        ...
        >
          ...
          >
            {/* Image */}
            <div className={`aspect-square ${selectedImage.bgColor} flex items-center justify-center`}>
